...
//var project = '<tr><td><h4 class="text-uppercase">%project%  <p class="year">(%year%) </p> </h4></td><td><p>%details%</p></td></tr><hr>';
var project = '<tr><td><h4 class="text-uppercase text-center">%project%  <p class="year">(%year%) </p> </h4></td></tr><tr><td><p>%details%</p></td></tr>';
...
for(var i=0; i < project_array.length; i +=1)
{
	...
	$('#projects-tab').append(project_new);
}
